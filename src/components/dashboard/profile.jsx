												...
												<table class="main__table">
													<thead>
														<tr>
															...
															<th><a href="#" class="active">Artist <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M17,9.17a1,1,0,0,0-1.41,0L12,12.71,8.46,9.17a1,1,0,0,0-1.41,0,1,1,0,0,0,0,1.42l4.24,4.24a1,1,0,0,0,1.42,0L17,10.59A1,1,0,0,0,17,9.17Z"/></svg></a></th>
													...
													<tbody>
														<tr>
															...
															<td>
																<div class="main__table-text"><a href="#">Calle 85</a></div>
															</td>
															<td>
																<div class="main__table-text">Tiago Santo</div>
															</td>
															<td>
																<div class="main__table-text">24/08/2021</div>
															</td>
															<td>
																<div class="main__table-text main__table-text--price">USD 500</div>
															</td>
															<td>
																<div class="main__table-text ">100</div>
															</td>
															<td>
																<div class="main__table-text main__table-text--price">USD 50</div>
															</td>
															<td>
																<div class="main__table-text main__table-text--price">40 %</div>
															</td>
